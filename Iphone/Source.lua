--!/usr/bin/env lua
-- iOSNotifFinalSource.lua (Version 6.0 - Iconless)
-- This version removes the icon completely for a text-focused design.
-- v0.9
...
-- Icon instances are now removed
