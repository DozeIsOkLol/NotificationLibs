--!/usr/bin/env lua
-- iOSNotifFinalSource.lua (Version 5 - Custom Timestamps & More Themes)
-- This version adds a customizable timestamp and several new built-in themes.
-- v0.6
...
local themes = {
    Light = {
        ...
        Transparency = 0.25,
        PrimaryText = Color3.fromRGB(15, 15, 15),
    ...
    Success = {
        Background = Color3.fromRGB(60, 110, 75),
        Transparency = 0.2,
        PrimaryText = Color3.fromRGB(230, 255, 235),
        SecondaryText = Color3.fromRGB(180, 220, 190)
    },
    Warning = {
        Background = Color3.fromRGB(120, 100, 50),
        Transparency = 0.2,
        PrimaryText = Color3.fromRGB(255, 245, 220),
        SecondaryText = Color3.fromRGB(220, 200, 160)
    },
    Error = {
        Background = Color3.fromRGB(120, 55, 55),
        Transparency = 0.2,
        PrimaryText = Color3.fromRGB(255, 230, 230),
        SecondaryText = Color3.fromRGB(220, 180, 180)
    },
    Info = {
        Background = Color3.fromRGB(50, 90, 120),
        Transparency = 0.2,
        PrimaryText = Color3.fromRGB(220, 235, 255),
        SecondaryText = Color3.fromRGB(160, 190, 220)
    }
}
...
function module.Notify(data)
    ...
    newNotif.TimestampLabel.Text = data.Timestamp or "now" -- <-- NEW FEATURE IMPLEMENTED HERE
